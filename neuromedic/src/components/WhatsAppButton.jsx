...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/51978516870?text=Hola%2C%20quisiera%20agendar%20una%20consulta%20en%20NEUROMEDIC%20JA%C3%89N"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contactar por WhatsApp"
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-green-500 text-white rounded-full shadow-2xl shadow-green-500/40 transition-all duration-300 hover:bg-green-600 hover:scale-110 hover:shadow-green-500/60 active:scale-95"
